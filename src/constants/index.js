...
const experiences = [
  {
    title: "Techno Kreaticon 2024",
    company_name: "Technology Pitch Competition – Event Organizer",
    icon: kre,
    iconBg: "#3e1d6d",
    date: "2024",
    points: [
      "Successfully planned and managed a large-scale tech innovation event at PPG Institute of Technology, ensuring seamless execution.",
      "Developed and maintained a live judging and scoring system to provide 100% transparent evaluations for participants",
      "Led the website and promotional material design, enhancing user engagement and streamlining registration processes",
      "Coordinated with multiple teams for venue setup, participant kits, and event logistics, ensuring a smooth experience for all attendees.",
  ...
  {
    title: "Illuminaty",
    company_name: "Full-Stack Messaging Application",
    icon: Illu,
    iconBg: "#fff146",
    date: "2024",
    points: [
      "Created a secure and feature-rich messaging platform supporting text chat, video calls, group chats, and file sharing.",
      "Implemented AES encryption to enhance security, ensuring end-to-end encryption for sensitive data.",
      "Designed a modern and minimalistic UI with React to deliver a smooth user experience on both Android and iOS platforms.",
    ],
  },
  {
    title: "SOS",
    company_name: "ndependent Project - steert operation support",
    icon: code1,
    iconBg: "#FF5733",
    date: "2025",
    points: [
      "Developed an innovative tech-based solution addressing a real-world problem, focusing on efficiency and practicality.",
      "Designed and implemented a scalable backend using Java Spring Boot with MySQL, ensuring high performance and data integrity.",
      "Integrated a React-based frontend for an intuitive user interface, enhancing usability and accessibility.",
      "Ensured security and reliability by incorporating JWT-based authentication and RESTful API principles.",
    ],
  },
  // {
